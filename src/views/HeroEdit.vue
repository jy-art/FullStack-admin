...
export default {
  ...
  methods: {
    async save() {
      let res;
      if (this.id) {
        res = await this.$http.put(`res/heroes/${this.id}`, this.model);
      } else {
        res = await this.$http.post("res/heroes", this.model);
      }
    ...
    async fetch() {
      const res = await this.$http.get(`res/heroes/${this.id}`);
    ...
    async fetchItems() {
     ...
     async fetchHeroes() {
      const res = await this.$http.get(`res/heroes`);
